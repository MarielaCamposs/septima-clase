...
function draw() {
  ...
  print("Eran " + hombres_muertos + " los hombres que viajaban en el titanic y murieron")
  print("Eran " + mujeres_muertos + " las mujeres que viajaban en el titanic y murieron")
